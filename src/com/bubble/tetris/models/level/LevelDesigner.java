...
import com.bubble.tetris.models.tetrimino.TetriminoGenerator;
import com.bubble.tetris.models.tetrimino.TetriminoGenerator.TColor;
import com.bubble.tetris.models.tetrimino.TetriminoGenerator.TetriminoShape;
...
public class LevelDesigner implements Drawable {
    ...
    public Tetrimino spawnTetrimino(Tetrimino tetrimino) {
        ...
        int y = -1;
        com.bubble.tetris.util.log.GameLogger.outdatedLog("Spawning at "+x+","+y);
