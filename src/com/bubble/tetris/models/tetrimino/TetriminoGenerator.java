...
import com.bubble.tetris.models.tetrimino.shapes.*;
...
public class TetriminoGenerator {
    ...
    public static Tetrimino random(int x, int y) {
        com.bubble.tetris.util.log.GameLogger.outdatedLog("trying to geneerate a tetrimono");
    ...
    private static <T extends Enum<T>> Enum<T> chooseRandom(Enum<T>[] e) {
        if (TetriminoGenerator.rand == null) {
            try {
                ...
                rand = new Random();
                com.bubble.tetris.util.log.GameLogger.warning("No such algorithm exception!");
            }
        }
        int i = rand.nextInt(e.length);
        com.bubble.tetris.util.log.GameLogger.outdatedLog("Generated "+e[i]);
        return e[i];
    }
    ...
    public enum TColor {
        ...
        public static Color get(TColor color) {
            switch (color) {
                ...
                com.bubble.tetris.util.log.GameLogger.log("Generated color: "+a+","+","+b+","+c);
